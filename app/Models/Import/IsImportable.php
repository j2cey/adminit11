...
trait IsImportable
{
    ...
    public function addOneToImport() {
        $this->importresult?->addOneToImport();
    }

    public function importToDoIs(int $nb_to_import): bool {
        return ($this->importresult->nb_to_import == $nb_to_import);
    }

    public function itemAlreadyImported(int $item): bool {
        return $this->importresult->itemAlreadyImported($item);
    }
    ...
    public function startingImport(int|null $nb_to_import): ImportResult {
        ...
        if ( ! is_null($nb_to_import) ) {
            $this->importresult->addManyToImport($nb_to_import);
        }
